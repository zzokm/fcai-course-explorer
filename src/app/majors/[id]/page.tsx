...
import { ArrowLeft, BookOpen, Clock, Tag, CaretDown } from "@phosphor-icons/react/dist/ssr";
    ...
    <main style={{ minHeight: '100dvh', position: 'relative' }}>
      ...
      <div className="container" style={{ paddingTop: '4rem', paddingBottom: '6rem', maxWidth: '900px' }}>
        <header style={{ textAlign: 'center', marginBottom: '4rem' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', background: 'var(--card-bg-outer)', padding: '1rem', borderRadius: '1.5rem', marginBottom: '1.5rem' }}>
          ...
          <p style={{ fontSize: '1.25rem', maxWidth: '600px', margin: '0 auto', opacity: 0.8 }}>
            Total Required Credits: <strong style={{ color: 'var(--foreground)' }}>{calculatedTotalCredits}</strong>
          </p>
        </header>
